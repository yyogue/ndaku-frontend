...
import { UseDatePickerBaseProps } from './use-date-picker-base.mjs';
import { DateRangePickerFieldProps } from './date-range-picker-field.mjs';
...
declare function useDateRangePicker<T extends DateValue>({ as, label, isInvalid: isInvalidProp, description, startContent, endContent, selectorIcon, errorMessage, className, classNames, ...originalProps }: UseDateRangePickerProps<T>): {
    ...
    classNames: (SlotsToClasses<"base" | "selectorButton" | "selectorIcon" | "popoverContent" | "calendar" | "calendarContent" | "timeInputLabel" | "timeInput" | "bottomContent" | "timeInputWrapper" | "separator"> & SlotsToClasses<"base" | "label" | "description" | "errorMessage" | "input" | "helperWrapper" | "inputWrapper" | "innerWrapper" | "segment">) | undefined;
