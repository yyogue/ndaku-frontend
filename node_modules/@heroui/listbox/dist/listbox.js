...
function useListbox(props) {
  ...
  const slots = (0, import_react.useMemo)(() => (0, import_theme.listbox)(), []);
...
function useDataScrollOverflow(props = {}) {
  ...
  const visibleRef = (0, import_react5.useRef)(visibility);
  (0, import_react5.useEffect)(() => {
    const el = domRef == null ? void 0 : domRef.current;
    if (!el || !isEnabled) return;
    const setAttributes = (direction, hasBefore, hasAfter, prefix, suffix) => {
      if (visibility === "auto") {
        const both = `${prefix}${(0, import_shared_utils4.capitalize)(suffix)}Scroll`;
    ...
    const checkOverflow = () => {
      ...
      const listbox2 = el.querySelector('ul[data-slot="list"]');
      const scrollHeight = +((_a = listbox2 == null ? void 0 : listbox2.getAttribute("data-virtual-scroll-height")) != null ? _a : el.scrollHeight);
      const scrollTop = +((_b = listbox2 == null ? void 0 : listbox2.getAttribute("data-virtual-scroll-top")) != null ? _b : el.scrollTop);
...
function useScrollShadow(originalProps) {
  var _a;
  const [props, variantProps] = (0, import_system4.mapPropsVariants)(originalProps, import_theme4.scrollShadow.variantKeys);
  const {
    ref,
    as,
    children,
  ...
  const styles = (0, import_react6.useMemo)(
    () => (0, import_theme4.scrollShadow)({
      ...variantProps,
      className
    }),
    [(0, import_shared_utils5.objectToDeps)(variantProps), className]
  );
  const getBaseProps = (props2 = {}) => {
    var _a2;
    return {
...
var VirtualizedListbox = (props) => {
  ...
  if (!virtualization || !(0, import_shared_utils6.isEmpty)(virtualization) && !virtualization.maxListboxHeight && !virtualization.itemHeight) {
    throw new Error(
  ...
  const itemSizes = (0, import_react7.useMemo)(
  ...
  const [scrollState, setScrollState] = (0, import_react7.useState)({
    isTop: false,
    isBottom: true,
    isMiddle: false
  });
    ...
    Component,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
          "div",
          {
            ...(0, import_react_utils4.filterDOMProps)(getBasePropsScrollShadow()),
            ref: parentRef,
            style: {
